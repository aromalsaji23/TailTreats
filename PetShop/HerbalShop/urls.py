...
urlpatterns = [
    ...
    path('delete_booking/<int:bid>/', delete_booking, name='delete_booking'),
    ...
    path('send_feedback/', Feedback, name='send_feedback_no_pid'),
    ...
    path('view_pet_profiles/', view_pet_profiles, name='view_pet_profiles'),
    path('delete_pet_profile_confirm/<int:pk>/', delete_pet_profile_confirm, name='delete_pet_profile_confirm'),
    path('sales-report/', monthly_sales_report, name='sales_report'),
